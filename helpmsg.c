...
/**
 * help_all - Displays all possible builtin nosh commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the nosh builtin command 'alias'.
 */
...
/**
 * help_cd - Displays information on the nosh builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the nosh builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the nosh builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible NOSH builtin commands.\n";
